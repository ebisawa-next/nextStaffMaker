...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "images/parts/hair/" . $array[$i];
    $filename2 = "images/parts/hair/cv/" . $array[$i];
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><div><input type=image class=ct name=hair img src= " .$filename. " onClick=bgImgChange('url($filename2)','hairParts');></div></td>");
