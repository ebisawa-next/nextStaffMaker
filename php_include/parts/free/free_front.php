...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "images/parts/free/front/" . $array[$i];
    $filename2 = "images/parts/free/front/cv/" . $array[$i];
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><div><input type=image name=ace img src= " .$filename. " onClick=bgImgChange('url($filename2)','otherParts');></div></td>");
...
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','otherParts');" img src= "images/none_s.png"></div></td></tr></table>
</div>