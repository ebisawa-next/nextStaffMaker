...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "images/parts/bhair/cv/" . $array[$i];
    $filename2 = "images/parts/bhair/" . $array[$i];
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><div><input type=image class=ct name=hair img src= " .$filename2. " onClick=bgImgChange('url($filename)','bhairParts');></div></td>");
...
?>
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','bhairParts');" img src= "images/none_s.png"></div></td></tr></table>
