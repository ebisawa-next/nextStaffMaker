...
$path = "images/parts/accessories/hokuro/";
...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "images/parts/accessories/hokuro/" . $array[$i];
    $filename2 = "images/parts/accessories/hokuro/cv/" . $array[$i];
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><div><input type=image name=body img src= " .$filename. " onClick=bgImgChange('url($filename2)','hokuroParts');></div></td>");
...
?>
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','hokuroParts');" img src= "images/none_s.png"></div></td></tr></table>
