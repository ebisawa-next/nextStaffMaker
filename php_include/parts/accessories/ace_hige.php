...
$path = "images/parts/accessories/hige";
...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "images/parts/accessories/hige/" . $array[$i];
    $filename2 = "images/parts/accessories/hige/cv/" . $array[$i];
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><div><input type=image name=body img src= " .$filename. " onClick=bgImgChange('url($filename2)','higeParts');></div></td>");
...
?>
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','higeParts');" img src= "images/none_s.png"></div></td></tr></table>
</div>
