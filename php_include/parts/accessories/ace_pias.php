...
$path = "images/parts/accessories/pias";
...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "images/parts/accessories/pias/" . $array[$i];
    $filename2 = "images/parts/accessories/pias/cv/" . $array[$i];
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><div><input type=image name=body img src= " .$filename. " onClick=bgImgChange('url($filename2)','piasParts');></div></td>");
...
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','piasParts');" img src= "images/none_s.png"></div></td></tr></table>
</div>