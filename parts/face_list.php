...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "parts/face/cv/" . $array[$i];
    $filenameThumb = "parts/face/" . $array[$i];
...
<table><tr><td>
<div><input type="image" name="mayu" onClick="bgImgChange('url(parts/face/cv/body01_sk01.png)','bodyLine');" img src= "parts/face/cv/body01_sk00.png"></div>
</td><td>
<div><input type="image" name="mayu" onClick="bgImgChange('url(parts/face/cv/body02_sk01.png)','bodyLine');" img src= "parts/face/cv/body02_sk00.png"></div>
</td></tr></table>
</div>
