...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "parts/cloth/tops/" . $array[$i];
 	$filename2 = "parts/cloth/tops/cv/" . $array[$i];
...
?>
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','clothParts');" img src= "images/none_s.png"></div></td></tr></table>
</div>
