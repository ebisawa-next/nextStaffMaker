...
for ($i=0;$i<$num;$i++){
    //$filenameにファイル名を設定
    $filename = "parts/mouth/" . $array[$i];
    $filename2 = "parts/mouth/cv/" . $array[$i];
...
?>
<td><div><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','mouthParts');" img src= "images/none_s.png"></div></td></tr></table>
</div>