...
#hige{
	width:127px;
	height:26px;
	background-image:url(images/hige.png);
	margin-bottom:10px;
	margin-top:10px;
	float:left;
	display:block;
...
for ($i=0;$i<$num;$i++){
    ...
    if  (
         Eregi('png$', $filename)) {
        print("<td><input type=image name=hige img src= " .$filename. " onClick=bgImgChange('url($filename)','bgImg_hoge12');></td>");
...
?>
<td><input type="image" name="mayu" onClick="bgImgChange('url(images/none.png)','bgImg_hoge12');" img src= "images/none_s.png"></td></tr></table>
